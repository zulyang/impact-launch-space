...
public class IndividualAccount {
	...
	// checking this makes the profile visible to others for
	// chatting/headhunting
	...
	public IndividualAccount(String username, String email, Date dateOfBirth, String first_name, String last_name,
			String country, String jobTitle, int minimumVolunteerHours, int maximumVolunteerHours, String organization,
			boolean isPublicProfile, File profilePicture, String personalBio, String contactDetails, ArrayList<File> documentList) {
		super();
	...
	public void setDocumentList(ArrayList<File> documentList) {
		this.documentList = documentList;
	}
