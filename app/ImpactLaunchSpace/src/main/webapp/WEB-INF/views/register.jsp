            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="col-lg-12 form_container" id="register_container">
                        ...
                        <form method="post" action="registernewuser" class="form-horizontal">                                                   
                            <br>
                    ...
                    <div class="col-lg-12 verify_container" id="verify_container" style="display:none;">
                        ...
                        <form class="form-horizontal">                                                   
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <button type="submit" value="Register" class="btn btn-success field" id="verify_button">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="col-lg-12 verify_success" id="verify_success" style="display:none;">
                        ...
                        <a href="/login1" class="btn btn-success signInNow" role="button">SIGN IN NOW</a>
                        <a href="/index" class="btn btn-default returnHome" role="button">Return to Home</a>
                    </div>
                </div>
            </div>
