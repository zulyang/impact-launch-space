...
<div align="center">
		...
		<h4>Min Hours: <input type="text" value="${individual.getMinimumVolunteerHours()}" name="personalBio"/>
		Max Hours: <input type="text" value="${individual.getMaximumVolunteerHours()}" name="personalBio"/></h4>
	</div>
	<br>
	<br>
	<div align="center">
