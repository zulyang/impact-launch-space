...
<body>
	<div align="center">
		...
		<form action="editprofile-individual" method="post">
			<h4>
				First Name: <input type="text" value="${individual.getFirst_name()}"
					name="firstName" /> Last Name: <input type="text"
					value="${individual.getLast_name()}" name="lastName" />
			</h4>
			<h4>
				Job Title: <input type="text" value="${individual.getJobTitle()}"
					name="jobTitle" />
			</h4>
			<h4>
				Organization: <input type="text"
					value="${individual.getOrganization()}" name="organization" />
			</h4>
			<h4>
				Date Of Birth: <input type="date"
					value="${individual.getDateOfBirth()}" name="dateOfBirth" />
			</h4>
			<h3>
				Country: <input type="text" value="${individual.getCountry()}"
					name="country" />
			</h3>
			<h4>
			...
			<h4>
				Phone: <input type="text" value="${individual.getContactDetails()}"
					name="contactDetails" />
			</h4>
			<h4>
				Personal Bio: <input type="text"
					value="${individual.getPersonalBio()}" name="personalBio" />
			</h4>
			<h4>
				Min Hours: <input type="number"
					value="${individual.getMinimumVolunteerHours()}"
					name="minimumVolunteerHours" /> Max Hours: <input type="number"
	...
	<div align="center">
      ...
      ${item.getSkillset()}<br>
		...
		<h4>
			<a href="individualprofile1">Go back to profile</a>
		</h4>
	</div>
</body>
</html>