                    ...
                    <div class="col-lg-12 form_container">
                        ...
                        <form class="form-horizontal">                                                   
                            <div class="form-group">   
                                <div class="col-lg-12">
                                    <input type="email" class="form-control field" id="inputEmail3" placeholder="Email">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <input type="password" class="form-control field" id="inputPassword3" placeholder="Password">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-lg-12">
