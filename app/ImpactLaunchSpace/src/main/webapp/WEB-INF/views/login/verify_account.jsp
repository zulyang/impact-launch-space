		...
		<div class="row">
			<div class="col-sm-12 col-md-12 col-lg-12">
				...
				<div class="col-lg-12 verify_container" id="verify_container">
					<h4 class="verifyAccountMessage">A verification token has been
						sent to your email. Please verify your account below.</h4>
				...
				<div class="col-lg-12 verify_success" id="verify_success"
					...
					<a href="/login" class="btn btn-success signInNowBox">SIGN IN
						NOW</a> <a href="/" class="btn btn-default returnHome" role="button">Return
						to Home</a>
				</div>
